...
class DisneyParkShowParadeAggregateList
{
     ...
     */
    public function filterPublishedOn(string $date): DisneyParkShowParadeAggregateList
    {
        return new DisneyParkShowParadeAggregateList(
    ...
    public function filterByParkType(int $parkType): DisneyParkShowParadeAggregateList
    {
        return new DisneyParkShowParadeAggregateList(
    ...
    public function add(DisneyParkShowParadeAggregate $aggregate)
    {
