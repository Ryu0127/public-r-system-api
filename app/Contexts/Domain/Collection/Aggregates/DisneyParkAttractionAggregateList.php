...
class DisneyParkAttractionAggregateList
{
     ...
     */
    public function filterPublishedOn(string $date): DisneyParkAttractionAggregateList
    {
        return new DisneyParkAttractionAggregateList(
    ...
    public function filterByParkType(int $parkType): DisneyParkAttractionAggregateList
    {
        return new DisneyParkAttractionAggregateList(
    ...
    public function add(DisneyParkAttractionAggregate $aggregate)
    {
